...
- CLAUDE.md memories can be used for both instructions shared with your team and for your individual preferences. </Tip>
...
- **Organize with subdirectories**: Group related rules (e.g., `frontend/`, `backend/`) </Tip>
