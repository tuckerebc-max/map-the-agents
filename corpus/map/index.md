...
Freshness counts: current=956, pending=10, stale=33, refresh-failed=63
...
- ... 76 more; see freshness/index.md

## Directory

Full index: [directory/index.md](directory/index.md).
Catalog-evidence entries (no-repo included): 1365 (published=836, backing=1347, pages=125).
