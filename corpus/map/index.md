...
Freshness counts: current=953, pending=10, stale=36, refresh-failed=63
...
- ... 79 more; see freshness/index.md

## Directory

Full index: [directory/index.md](directory/index.md).
Catalog-evidence entries (no-repo included): 1365 (published=836, backing=1347, pages=150).
