...
Traycer addresses the fragmentation of running multiple coding agents: each lives in its own chat, plans live in scrollback, and handing work between agents means re-explaining everything. It sits abo
