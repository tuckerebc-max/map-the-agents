# agentic-coding-intro (`agentic-coding-intro`)
...
- License: NOASSERTION
- Language: Markdown
- Interface: install=N/A - tutorial/handout repo (examples use Python and R)
...
Repository map entry: [seandavi/agentic-coding-intro](../../repos/seandavi/agentic-coding-intro.md) (source: backing, field: `source_code_url`).
