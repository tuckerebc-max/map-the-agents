...
SWE-Dev, from Tsinghua's THUDM lab, tackles the data bottleneck for open software-engineering agents. Its pipeline crawls top PyPI repositories, mines issues and PRs into tasks, generates Gherkin-styl
