...
- Model providers: Anthropic (Claude Code), OpenAI (Codex), OpenRouter, Google (Gemini), xAI (Grok), GitHub Copilot, Z.AI, MiniMax, Kiro, Kimi, local (free model, no auth)
- Feature flags (directory-reported):
  - mcp_support: yes (built-in mcp-server, .mcp.json config) (yes)
...
Repository map entry: [777genius/agent-teams-ai](../../repos/777genius/agent-teams-ai.md) (source: backing, field: `source_code_url`).
