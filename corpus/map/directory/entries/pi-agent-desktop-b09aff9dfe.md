...
pi-agent-desktop exists for developers who want pi's terminal-grade coding agent without maintaining a CLI environment, packaging the agent core, the pi-web interface, and the Pi SDK into a Tauri appl
