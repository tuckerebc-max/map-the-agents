...
Codebase-index-cli exists because most coding assistants locate code through text matching, which fails on semantic queries like 'where is rate limiting enforced.' It watches a workspace continuously,
