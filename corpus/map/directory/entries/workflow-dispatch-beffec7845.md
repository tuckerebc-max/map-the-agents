...
workflow-dispatch addresses the lack of native workflow-to-workflow chaining in GitHub Actions: it triggers other workflows through the workflow_dispatch event, optionally waits for their completion,
