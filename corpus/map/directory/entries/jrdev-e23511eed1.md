...
jrdev targets developers who want a terminal agent that spends expensive models only where they pay off. The /init pass builds a project overview and convention profile that grounds later generations.
