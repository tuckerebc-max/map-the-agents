...
Intent reframes the developer's role around direction-setting: tasks are declared at the level of outcomes, and a Coordinator agent decomposes each into a Living Spec that every assigned agent works f
