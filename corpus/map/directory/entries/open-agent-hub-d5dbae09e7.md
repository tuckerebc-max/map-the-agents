...
open-agent-hub addresses the fragmentation of agent configuration formats across coding assistants by maintaining one library of skills, agent role definitions, and slash commands that activate into a
