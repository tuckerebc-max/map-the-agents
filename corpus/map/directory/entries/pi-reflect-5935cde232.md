...
pi-reflect exists because behavioral rules for coding agents decay: instructions get ignored, the same mistakes recur, and nobody revisits the behavioral files that were supposed to prevent them. The
