...
Building a DuckDB extension means compiling against multiple DuckDB versions across Linux, macOS, and Windows with matching toolchains — a configuration burden that used to be duplicated in every exte
