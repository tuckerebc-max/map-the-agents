...
ValueCell applies the multi-agent pattern to investing rather than software development: specialized agents perform fundamental document research, execute multi-strategy trading across crypto assets,
