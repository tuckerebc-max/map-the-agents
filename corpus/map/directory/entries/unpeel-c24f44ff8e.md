...
Unpeel exists because long agent runs are fragile: close the terminal or laptop lid and the session dies, and there is no way to check on or approve an agent's work from away from the desk. It hosts a
