...
tmux is a terminal multiplexer in the classic sense: it lets one screen create, access, and control many terminal sessions, with sessions detaching and continuing to run on a background server so work
