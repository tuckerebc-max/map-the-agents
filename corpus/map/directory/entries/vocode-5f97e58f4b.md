...
Vocode exists to remove the plumbing from real-time voice LLM applications: managing interruptible streaming audio, transcription, and synthesis across many vendors. It provides a modular Python pipel
