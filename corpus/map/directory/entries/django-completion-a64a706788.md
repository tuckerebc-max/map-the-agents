...
Coding agents routinely misinvoke django-admin because the available commands, flags, and migration names live only in --help output, which is expensive to discover at runtime. django-completion pre-c
