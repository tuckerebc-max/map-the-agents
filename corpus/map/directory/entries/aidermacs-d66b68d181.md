...
The package is a community-driven fork of aider.el that rebuilt the integration to be Emacs-native: Magit-style transient menus, comint or vterm backends, Tramp support for remote files, and file watc
