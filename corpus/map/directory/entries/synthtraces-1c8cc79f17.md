...
Synthtraces exists to supply realistic multi-turn interaction data for coding-agent research without proprietary logs. Each generated session boots the Pi coding agent with read, write, edit, and bash
