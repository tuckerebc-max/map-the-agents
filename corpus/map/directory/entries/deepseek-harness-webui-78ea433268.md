# DeepSeek Harness WebUI (`deepseek-harness-webui`)
...
DeepSeek Harness WebUI is a small JetBrains plugin by an indie developer (M39/Chocomintopia) that docks the DeepSeek Harness agent's web interface into an IDE tool window rendered by the bundled Chrom
