...
The extension ports the review behavior of Google's Code Assist GitHub app into a local Gemini CLI session, so developers get review feedback on their working branch before pushing. The /code-review c
