...
The repository demonstrates an architectural idea rather than a product: using Apache Flink SQL, running on Confluent Cloud, as the orchestrator of a multi-agent sales workflow instead of a convention
