# App Developer Copilot (`app-developer-copilot`)
...
- Category: agent
- Provider/maker: Sinduja Ramaraj
- License: unknown
- Language: unknown
...
The extension targets developers who want app scaffolding without leaving VS Code: a /create command triggers prompt analysis, feature listing, design reference ingestion (images or Figma links), arch
