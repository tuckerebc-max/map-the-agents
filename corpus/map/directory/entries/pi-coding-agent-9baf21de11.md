...
pi-coding-agent brings pi into Emacs on RPC rather than terminal emulation, so the package receives structured messages and tool events instead of scraping ANSI output — the difference between a real
