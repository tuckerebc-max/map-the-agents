...
SWE-Interact, from Scale AI, rethinks SWE evaluation around how engineers actually work with agents: long sessions in which requirements shift and the user supplies context. Its 75 tasks run inside th
