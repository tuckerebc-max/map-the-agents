...
winx-code-agent provides durable, remote-first tool access for coding agents that connect over MCP: real PTY shell sessions survive HTTP disconnects, client restarts, and adapter upgrades because a se
