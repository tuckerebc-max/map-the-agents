...
Repository map entry: [kadeai/kade](../../repos/kadeai/kade.md) (source: backing, field: `source_code_url`).

## Description

(published index `description`, not a verified repo-code finding)
Kade takes the Cline lineage and rebuilds it around two bets: hierarchical multi-agent execution and aggressive context engineering. The main agent spawns sub-agents into their own tabs with isolated
