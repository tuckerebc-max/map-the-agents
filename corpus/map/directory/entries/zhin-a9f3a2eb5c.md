...
zhin.js is a framework for building bots that live on instant-messaging platforms, and its design treats multi-platform reach as the primary problem: one TypeScript codebase, with adapters targeting m
