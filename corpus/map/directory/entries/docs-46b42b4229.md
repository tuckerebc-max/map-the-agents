...
Highlight (site page `what_makes_it_special`): Associated link: documentation site for 01, an open-source voice interface platform for intelligent devices (desktop, mobile, ESP32) powered by Open Interpreter; assistants execute code, browse the web, manage files, and control software

(captured site page body (agents/docs.md), not a verified repo-code finding)
...
Sources: [backing feed @ 0709cccb49af](https://github.com/prime-radiant-inc/alltheagents.org/blob/0709cccb49aff08a4b10beb95a214005a810a363/_data/agents.json); [site page @ 0709cccb49af](https://github.com/prime-radiant-inc/alltheagents.org/blob/0709cccb49aff08a4b10beb95a214005a810a363/agents/docs.md)
