...
Zellij rebuilds the terminal multiplexer concept that tmux and GNU screen have held for decades around modern development habits. It ships friendly default keybindings with on-screen hints so new user
