...
StemCode is built around operating inside a real local repository rather than a detached chat sandbox: repository-aware search, LSP symbol intelligence, and graph-aware indexing feed surgical tracked
