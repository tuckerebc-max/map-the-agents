...
perles exists for developers who manage their work in Beads, Steve Yegge's local-first issue tracker, and want a richer interface than its CLI offers. The Go-based terminal UI renders issues as custom
