...
HMRAG is the research code accompanying a peer-reviewed paper on hierarchical multi-agent retrieval-augmented generation. A Decomposition Agent rewrites complex queries into sub-tasks; retrieval agent
