...
Murmell solves the coordination problem that appears when several AI agents — and the humans supervising them — work on one repository: conflicting writes, invisible progress, and agents that die with
