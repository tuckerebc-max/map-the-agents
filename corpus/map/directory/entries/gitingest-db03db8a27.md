...
Getting a whole repository into an LLM context is awkward, and GitIngest exists to make it a single step. It clones or reads a repo and emits a formatted digest — summary, directory tree, file content
