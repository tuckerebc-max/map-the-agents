...
Rayu CLI is a terminal coding agent built around a claim most competitors lack: native peer-to-peer collaboration, where two developers share a live agent session directly rather than relaying through
