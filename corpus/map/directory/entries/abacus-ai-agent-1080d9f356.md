# Abacus AI Agent (`abacus-ai-agent`)
...
Repository map entry: [abacusai/abacusai-desktop](../../repos/abacusai/abacusai-desktop.md) (source: backing, field: `source_code_url`).

## Description

Highlight (site page `what_makes_it_special`): AI-powered coding assistant/agent for VS Code

(captured site page body (agents/abacus-ai-agent.md), not a verified repo-code finding)
...
Sources: [published index (sha256:ae063493534e)](https://alltheagents.org/agents.json); [backing feed @ 0709cccb49af](https://github.com/prime-radiant-inc/alltheagents.org/blob/0709cccb49aff08a4b10beb95a214005a810a363/_data/agents.json); [site page @ 0709cccb49af](https://github.com/prime-radiant-inc/alltheagents.org/blob/0709cccb49aff08a4b10beb95a214005a810a363/agents/abacus-ai-agent.md)
