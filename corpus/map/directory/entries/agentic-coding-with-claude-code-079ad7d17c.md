# Agentic-Coding-with-Claude-Code (`agentic-coding-with-claude-code`)
...
- Interface: install=git clone; follow chapter examples. Requires Node.js, Next.js, Claude Code access, and GitHub CLI.
...
Repository map entry: [packtpublishing/agentic-coding-with-claude-code](../../repos/packtpublishing/agentic-coding-with-claude-code.md) (source: backing, field: `source_code_url`).
