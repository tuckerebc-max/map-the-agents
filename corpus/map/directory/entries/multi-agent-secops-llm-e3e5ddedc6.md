...
This is a personal proof-of-concept for LLM-driven security analysis, notable mainly for its simplicity: one Python file reads text files from a dataops folder, passes them through four specialized ag
