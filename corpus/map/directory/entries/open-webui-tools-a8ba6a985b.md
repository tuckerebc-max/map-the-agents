...
Open WebUI ships as a chat front end, and operators who self-host it often want search, media generation, and autonomous behavior without assembling each integration from scratch. This repository pack
