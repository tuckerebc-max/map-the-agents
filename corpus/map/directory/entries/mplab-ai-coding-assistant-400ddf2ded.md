# MPLAB AI Coding Assistant (`mplab-ai-coding-assistant`)
...
- Category: agent
- Provider/maker: Microchip Technology
- License: unknown
- Language: unknown
...
Microchip adapted the open-source Continue extension for its embedded ecosystem, where generic assistants hallucinate register names and peripheral configurations that a datasheet-grounded model would
