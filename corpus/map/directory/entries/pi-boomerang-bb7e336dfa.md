...
pi-boomerang exists because autonomous agent tasks generate enormous turn histories that crowd out useful context in every later turn. The extension runs a task from start to finish without questions,
