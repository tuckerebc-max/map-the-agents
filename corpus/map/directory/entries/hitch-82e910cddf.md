...
hitch addresses the gap between a coding agent and the terminal session the developer is actually working in. Running hitch wraps the current shell as a transparent proxy: the human keeps typing norma
