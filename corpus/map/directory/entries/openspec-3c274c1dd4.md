...
AI coding assistants routinely build the wrong thing because intent lives in a chat transcript rather than a reviewable artifact. OpenSpec inserts a lightweight spec process: openspec init scaffolds a
