...
- License: MIT
- Language: Shell
- Interface: install=git clone and bash install.sh (Claude Code) or --cursor (Cursor) or --both; MCP server via npm install -g alive-analysis-mcp
...
Repository map entry: [with-geun/alive-analysis](../../repos/with-geun/alive-analysis.md) (source: backing, field: `source_code_url`).
...
Sources: [backing feed @ 61d64ce1ee2e](https://github.com/prime-radiant-inc/alltheagents.org/blob/61d64ce1ee2eae6b23dcef8ea9f31bc2c8b75fd0/_data/agents.json); [site page @ 61d64ce1ee2e](https://github.com/prime-radiant-inc/alltheagents.org/blob/61d64ce1ee2eae6b23dcef8ea9f31bc2c8b75fd0/agents/alive-analysis.md)
