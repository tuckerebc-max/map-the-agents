...
SpecBuddy exists because chat-driven coding only reveals an agent's misunderstanding after the diff exists. Its workflow starts with a Markdown spec in the editor — the agent can expand a short draft
