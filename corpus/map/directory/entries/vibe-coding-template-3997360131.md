...
The template addresses the cost and inconsistency of pointing a coding agent at an empty repository: the agent invents project structure, rewrites boilerplate, and drifts from the intended stack with
