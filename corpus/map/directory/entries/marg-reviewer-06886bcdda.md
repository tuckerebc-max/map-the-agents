...
The repository accompanies Allen AI's study of whether multi-agent LLM pipelines can produce useful scientific peer reviews, providing the web interface used in the paper's user study alongside script
