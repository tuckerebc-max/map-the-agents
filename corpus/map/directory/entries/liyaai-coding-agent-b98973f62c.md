# LiyaAI Coding Agent (`liyaai-coding-agent`)
...
LiyaAI Coding Agent embeds an autonomous agent loop into JetBrains IDEs: it plans multi-step coding tasks, reads and edits project files, executes terminal commands, and works with Git from a chat too
