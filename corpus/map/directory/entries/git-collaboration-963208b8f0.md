...
- Category: other
- Provider/maker: jduckles
- License: No license file in the repository
- Language: Shell, Markdown
- Interface: install=n/a (browse or fork the repository)
...
Repository map entry: [jduckles/git-collaboration](../../repos/jduckles/git-collaboration.md) (source: backing, field: `source_code_url`).
