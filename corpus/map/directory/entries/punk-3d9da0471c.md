...
PUNK separates where an agent runs from where a human directs it: Claude Code sessions execute on your laptop while your iPhone becomes the control terminal, letting you approve permission requests fr
