...
The premise is that an agent with write access cannot be trusted to report its own test results — it can weaken a failing test, delete the evidence, or replace real assertions with mock-echo tests. rg
