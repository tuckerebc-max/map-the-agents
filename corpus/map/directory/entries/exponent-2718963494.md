...
Exponent built an AI software engineer around the workflow where work actually arrives: a bug report in Slack or a GitHub issue could be handed to the agent, which ran in a cloud sandbox, produced a f
