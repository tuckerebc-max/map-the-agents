...
Rowboat started as an AI app-builder project and repositioned as a local-first "AI coworker": a desktop app that indexes the user's work into a persistent, backlinked knowledge graph rather than retri
