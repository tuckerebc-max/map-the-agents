...
HASS-AI-Orchestrator brings LLM reasoning to Home Assistant without giving the model unsupervised control. An agent observes entity states, areas, and device metadata, then proposes changes as recorde
