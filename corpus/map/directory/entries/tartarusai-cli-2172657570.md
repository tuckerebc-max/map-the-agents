...
tartarusai-cli is the terminal client for a hosted coding-agent service that competes on policy: it advertises itself as an uncensored agent that will handle work mainstream tools decline, such as wri
