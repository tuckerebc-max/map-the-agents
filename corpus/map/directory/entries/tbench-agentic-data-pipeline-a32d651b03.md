...
The pipeline exists because RL training for terminal agents needs large quantities of verified, executable tasks, and hand-curation does not scale. It turns Terminal Bench seed tasks into training dat
