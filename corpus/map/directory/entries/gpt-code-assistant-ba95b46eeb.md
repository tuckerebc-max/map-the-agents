...
The tool indexes a local codebase into vector embeddings and lets developers ask natural-language questions in the terminal, with GPT-4 retrieving the most relevant snippets and sending only those sni
