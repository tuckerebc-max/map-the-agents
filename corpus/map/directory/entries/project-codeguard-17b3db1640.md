...
Project CodeGuard exists because security guidance for AI coding agents was fragmented across vendor-specific formats with no neutral governance. The Coalition for Secure AI, an OASIS-hosted industry
