...
- Model providers: Anthropic Claude, OpenAI GPT (mid-session model picker)
...
Highlight (site page `what_makes_it_special`): Turn-based Salesforce agent combining Claude Agent SDK or OpenAI Agents SDK

(captured site page body (agents/agentforce-vibes.md), not a verified repo-code finding)
...
Sources: [published index (sha256:ae063493534e)](https://alltheagents.org/agents.json); [backing feed @ 0709cccb49af](https://github.com/prime-radiant-inc/alltheagents.org/blob/0709cccb49aff08a4b10beb95a214005a810a363/_data/agents.json); [site page @ 0709cccb49af](https://github.com/prime-radiant-inc/alltheagents.org/blob/0709cccb49aff08a4b10beb95a214005a810a363/agents/agentforce-vibes.md)
