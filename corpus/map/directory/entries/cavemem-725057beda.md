...
cavemem exists because coding agents lose context between sessions, forcing them to re-derive decisions and repeat mistakes. It installs hook handlers across nine coding assistants — Claude Code, Open
