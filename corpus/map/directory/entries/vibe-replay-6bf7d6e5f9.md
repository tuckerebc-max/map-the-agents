...
AI coding sessions disappear when the terminal closes: reviewers see only the final diff, and the prompts, dead ends, and tool calls that produced it are lost. Vibe-replay converts session logs from C
