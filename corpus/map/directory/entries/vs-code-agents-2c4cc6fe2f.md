...
vs-code-agents exists because unstructured Copilot sessions forget context, skip quality gates, and lose decision history. It defines 13 custom agents (planner, analyst, architect, security, critic, i
