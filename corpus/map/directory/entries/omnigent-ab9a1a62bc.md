...
Omnigent provides a uniform orchestration layer over existing coding agents, letting one session supervise a Claude Code instance while an OpenCode agent reviews its output. Harnesses swap without rew
