...
OpenCode Desktop's agent produces diffs, but nothing forces it to work from verified repository context or to prove its commands actually ran against the current tree. OpenCode++ inserts that layer as
