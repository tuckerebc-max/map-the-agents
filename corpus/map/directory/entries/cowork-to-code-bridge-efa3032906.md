...
Claude Cowork runs in a cloud sandbox that cannot reach the local machine, so any task needing the real filesystem - builds, tests, commits - stops at the sandbox wall. This bridge connects the two en
