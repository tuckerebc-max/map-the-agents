...
Deepunit attacked the chore side of testing: instead of asking a model for one test at a time, it ingested a repository and worked toward coverage of the whole project, a workflow that suits teams mai
