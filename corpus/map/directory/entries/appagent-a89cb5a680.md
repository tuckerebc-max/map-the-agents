...
AppAgent addresses GUI automation without backend access: an LLM-driven agent explores an app either autonomously or by watching human demonstrations, tagging interactive elements in screenshots and w
