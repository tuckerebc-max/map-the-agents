...
The project's thesis is that a persona encoded in the system prompt changes coding-agent behavior as much as the underlying model, so it packages sixteen agents spanning analysts, diplomats, sentinels
